...
use Akhil\Shop\Model\ContactFactory;
...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _construct()
    {
        ...
        if ($this->getRequest()->getParam('shop_id')) {
    ...
    {
        /* @var $model \Akhil\Shop\Model\Slide */
        $model = $this->_objectManager->get('\Akhil\Shop\Model\Contact');
    ...
    {
        $contactId = $this->getRequest()->getParam('shop_id');
